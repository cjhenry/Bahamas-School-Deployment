$ConfigData=@{
    ...
    AllNodes = @(
       ...
       @{
            ...
            PullServerThumbPrint = Invoke-Command -Computername $PullServer {Get-Childitem Cert:\LocalMachine\My | Where-Object {$_.FriendlyName -like "*dsccert*"} | Select-Object -ExpandProperty ThumbPrint}
